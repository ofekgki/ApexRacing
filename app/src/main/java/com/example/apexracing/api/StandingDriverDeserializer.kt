...
class StandingDriverDeserializer: JsonDeserializer<List<FlatDriverStanding>> {
        override fun deserialize(json: JsonElement, typeOfT: Type, context: JsonDeserializationContext):
            ...
            try {
                ...
                val driverStandingsArray = json.asJsonObject
                ...
                for (element in driverStandingsArray) {
                    ...
                    val fullName = "${driverObj.get("givenName").asString} ${driverObj
                        .get("familyName").asString}"
                    ...
                    parsedList.add(FlatDriverStanding(points, position, fullName,
                        teamName, color))
                }
            } catch (e: Exception) {
                e.printStackTrace()
